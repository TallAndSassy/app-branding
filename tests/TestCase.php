...
namespace TallAndSassy\AppBranding\Tests;

use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Facades\Route;
use Orchestra\Testbench\TestCase as Orchestra;
use TallAndSassy\AppBranding\AppBrandingServiceProvider;
...
class TestCase extends Orchestra
{
    ...
    public function setUp(): void
    {
        ...
        Factory::guessFactoryNamesUsing(
            fn (string $modelName) => 'TallAndSassy\\AppBranding\\Database\\Factories\\'.class_basename($modelName).'Factory'
        );

        // route prefix
        // this must match/sync with what was put in
        // tests/Feature/Http/Controllers/AppBrandingControllerTest.php/setup
    ...
    {
        return [
            AppBrandingServiceProvider::class,
        ];
    }
    ...
    public function getEnvironmentSetUp($app)
    {
        ...
        include_once __DIR__.'/../database/migrations/create_app_branding_table.php';
        (new \CreateAppBrandingTable())->up();
    }
}
